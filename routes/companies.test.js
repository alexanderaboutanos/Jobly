...
describe("POST /companies", function () {
  ...
  test("not okay for users", async function () {
    const resp = await request(app)
      .post("/companies")
      .send(newCompany)
...
describe("GET /companies", function () {
  ...
  test("test filter, minimum", async function () {
    const query = { minEmployees: 1 };
  ...
  test("test filter, maximum", async function () {
  ...
  test("test filter, nameLike", async function () {
    const query = { nameLike: "c1" };
    const resp = await request(app).get("/companies").query(query);
    expect(resp.body).toEqual({
      companies: [
        {
